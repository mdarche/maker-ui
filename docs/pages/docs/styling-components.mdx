...
When prototyping, it's often easiest to bake styles directly into your JSX. This strategy works really well when you can keep your files small with a modular component architecture.
