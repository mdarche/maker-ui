...
The core Maker UI library includes [layout components](/docs/layout-api) as well as basic [primitives](/docs/primitives) that you can use as building blocks in your page designs.
