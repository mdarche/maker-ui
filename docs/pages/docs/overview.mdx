...
Whenever you want to build responsive styles, just import any of the components from `@maker-ui/primitives` or `@maker-ui/elements`. They can be used independently of the layout system.
