...
Maker UI components support the responsive `css` and `breakpoints` props. Never write a media query again! You can use style arrays that correspond with breakpoints to build media queries:
