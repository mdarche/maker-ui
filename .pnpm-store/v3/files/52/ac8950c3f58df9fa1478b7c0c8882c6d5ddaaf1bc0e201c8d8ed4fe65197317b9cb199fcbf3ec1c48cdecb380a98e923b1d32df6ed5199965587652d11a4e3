...
_chunkBYILCV74js.__export.call(void 0, colorette_exports, {
  bgBlack: () => bgBlack,
...
var none = (any) => any;
var createColors = ({ useColor = isColorSupported } = {}) => useColor ? colors : Object.keys(colors).reduce((colors2, key) => _chunkBYILCV74js.__spreadProps.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, {}, colors2), { [key]: none }), {});
var {
  reset,
  bold,
  dim,
