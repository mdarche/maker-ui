import { toChunks, toArray, removeFromArray, removeIfMatchPattern, } from './index';
describe('next-sitemap/array', () => {
    ...
    test('removeIfMatchPattern', () => {
        expect(removeIfMatchPattern(['/hello', '/world', '/something'], ['/hello*', '/som*'])).toStrictEqual(['/world']);
    });
});
