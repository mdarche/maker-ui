...
var require_flat = _chunkBYILCV74js.__commonJS.call(void 0, {
...
// src/cli-main.ts
_chunkBYILCV74js.init_cjs_shims.call(void 0, );
var import_flat = _chunkBYILCV74js.__toModule.call(void 0, require_flat());
var _fs = require('fs');
...
async function main(options = {}) {
  ...
  cli.command("[...files]", "Bundle files", {
    ...
    Object.assign(options, _chunkBYILCV74js.__spreadValues.call(void 0, {}, flags));
    if (files.length > 0) {
      options.entry = files.map(_chunkBYILCV74js.slash);
    }
    if (flags.format) {
