...
var require_string_argv = _chunkBYILCV74js.__commonJS.call(void 0, {
...
var require_consola = _chunkBYILCV74js.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunkBYILCV74js.__require.call(void 0, "util"));
    var e = _chunkBYILCV74js.__require.call(void 0, "path");
    var t = _chunkBYILCV74js.__require.call(void 0, "fs");
    var r = u(_chunkBYILCV74js.__require.call(void 0, "os"));
    var n = u(_chunkBYILCV74js.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var _ = class {
      constructor(u2 = {}) {
        ...
        for (const u3 in this._types) {
          const D2 = _chunkBYILCV74js.__spreadValues.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, { type: u3 }, this._types[u3]), this._defaults);
      ...
      _logFn(u2, D2, e2) {
        ...
        const r2 = (u3 = false) => {
          ...
          if (this._lastLog && D3 > 0) {
            ...
            D3 > 1 && u4.push(`(repeated ${D3} times)`), this._log(_chunkBYILCV74js.__spreadProps.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, {}, this._lastLog), { args: u4 })), this._lastLogCount = 1;
          }
          if (u3) {
    ...
    }, _chunkBYILCV74js.__spreadProps.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, {}, _u), { level: { enumerable: true, get() {
    ...
    var Gu = typeof __non_webpack_require__ != "undefined" ? __non_webpack_require__ : _chunkBYILCV74js.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
...
var import_string_argv = _chunkBYILCV74js.__toModule.call(void 0, require_string_argv());
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async (file) => {
        const loadConfig = _chunkBYILCV74js.__require.call(void 0, "postcss-load-config");
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins || plugins.length > 0) {
          const postcss = _chunkBYILCV74js.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
          ...
          const result = await (postcss == null ? void 0 : postcss.default(plugins).process(contents, _chunkBYILCV74js.__spreadProps.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, {}, options), { from: args.path })));
          contents = result.css;
        }
        if (inject) {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunkBYILCV74js.localRequire.call(void 0, "svelte/compiler");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunkBYILCV74js.__toModule.call(void 0, require_consola());
...
var swcPlugin = ({ logger }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunkBYILCV74js.localRequire.call(void 0, "@swc/core");
      if (!swc) {
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => ({
        path: _chunkBYILCV74js.__require.resolve(args.path, { paths: [args.resolveDir] }),
        namespace: "node-file"
      }));
...
async function runEsbuild(options, {
  ...
  const pkg = await _chunkJFWAFKAVjs.loadPkg.call(void 0, process.cwd());
  ...
  const env = _chunkBYILCV74js.__spreadValues.call(void 0, {}, options.env);
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      loader: _chunkBYILCV74js.__spreadValues.call(void 0, {
        ".aac": "file",
        ".css": "file",
        ".eot": "file",
        ".flac": "file",
      ...
      plugins: esbuildPlugins.filter(_chunkBYILCV74js.truthy),
      define: _chunkBYILCV74js.__spreadValues.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, {}, format === "cjs" && injectShims ? {
...
var es5 = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunkBYILCV74js.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkJHDYFHQIjs.PrettyError)("@swc/core is required for es5 target. Please install it with `npm install @swc/core -D`");
      }
...
var sizeReporter = () => {
  return {
    ...
    buildEnd({ writtenFiles }) {
      _chunkJFWAFKAVjs.reportSize.call(void 0, this.logger, this.format, writtenFiles.reduce((res, file) => {
        return _chunkBYILCV74js.__spreadProps.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, {}, res), {
          [file.name]: file.size
        });
      }, {}));
...
var normalizeOptions = async (logger, optionsFromConfigFile, optionsOverride) => {
  var _a, _b, _c, _d;
  const _options = _chunkBYILCV74js.__spreadValues.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, {}, optionsFromConfigFile), optionsOverride);
  const options = _chunkBYILCV74js.__spreadProps.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, {
    target: "node12",
    format: ["cjs"],
    outDir: "dist"
  }, _options), {
  ...
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkJHDYFHQIjs.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkJHDYFHQIjs.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkJHDYFHQIjs.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
  ...
  if (tsconfig) {
    ...
    throw new (0, _chunkJHDYFHQIjs.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  return options;
};
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkJFWAFKAVjs.loadTsupConfig.call(void 0, process.cwd());
  ...
  await Promise.all([...Array.isArray(configData) ? configData : [configData]].map(async (item) => {
    var _a;
    const logger = _chunkJFWAFKAVjs.createLogger.call(void 0, item == null ? void 0 : item.name);
    ...
    if (options.dts) {
      ...
      worker.postMessage({
        ...
        options: _chunkBYILCV74js.__spreadProps.call(void 0, _chunkBYILCV74js.__spreadValues.call(void 0, {}, options), {
          banner: void 0,
          footer: void 0,
    ...
    if (!((_a = options.dts) == null ? void 0 : _a.only)) {
      ...
      const debouncedBuildAll = _chunkBYILCV74js.debouncePromise.call(void 0, () => {
        return buildAll();
      }, 100, _chunkJHDYFHQIjs.handleError);
      const buildAll = async () => {
        ...
        if (options.clean) {
          ...
          await _chunkBYILCV74js.removeFiles.call(void 0, ["**/*", "!**/*.d.ts", ...extraPatterns], options.outDir);
      ...
      const startWatcher = async () => {
        ...
        watcher.on("all", (type, file) => {
          file = _chunkBYILCV74js.slash.call(void 0, file);
