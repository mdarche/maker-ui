...
export const ErrorIcon = (props: SVGProps) => (
  <SVG className="icon-error" viewBox="0 0 32 32" {...props}>
...
export const SaveIcon = (props: SVGProps) => (
  <SVG className="icon-save" viewBox="0 0 26 26" {...props}>
...
export const SuccessIcon = (props: SVGProps) => (
  <SVG className="icon-success" {...props} viewBox="0 0 30 30">
...
export const InfoIcon = (props: SVGProps) => (
  <SVG className="icon-info" {...props} viewBox="0 0 20 20">
