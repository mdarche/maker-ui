...
describe('MobileMenu component', () => {
  ...
  it('centers the mobile menu content with the center prop', () => {
    cy.mount(<TestMobileMenu center>s-inner</TestMobileMenu>)
  ...
  it('accepts and renders a default collapsible menu', () => {
    ...
    cy.mount(<TestMobileMenu menu={menu} />)
    cy.viewport('iphone-x').get('.widget-slot .menu-button').click()
  ...
  it('supports `top-right` position for the close button', () => {
    cy.mount(<TestMobileMenu>inner</TestMobileMenu>)
  ...
  it('supports `top-left` position for the close button', () => {
    cy.mount(
      <TestMobileMenu closeButtonPosition="top-left">inner</TestMobileMenu>
    )
    cy.get('#mobile-menu .menu-button').should('have.css', 'top')
