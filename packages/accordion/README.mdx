...
Go to [maker-ui.com](https://maker-ui.com/docs/getting-started) for full installation instructions.
...
| `customIcon`  | `React.ReactElement`<br/> \| `{ expand: React.ReactElement, collapse: React.ReactElement }` <br/> \| `((isExpanded: boolean) => React.ReactNode)` | An optional icon, set of icons, or callback function that can be used to supply a custom accordion toggle icon.                                                                                                                |
