...
// TODO have one source of truth for all constants in the entire framework... easily localized
...
/**
 * Utility function for creating an acceptable layout type
 *
 * @todo - convert all 3 of these functions to a useLayoutDetector hook that also returns an error
 */
