...
describe('SideNav', () => {
  ...
  it('can hide the toggle button on mobile', () => {
    cy.mount(
      <TestSideNav options={{ sideNav: { showToggleOnMobile: false } }} />
    )
  ...
  it('can be controlled by mobile nav button on mobile browsers', () => {
    cy.mount(
      <TestSideNav options={{ sideNav: { isPrimaryMobileNav: true } }} />
    )
  ...
  it('accepts and renders a default collapsible menu', () => {
    ...
    cy.mount(<TestSideNav menu={menu} />)
  ...
  it('renders custom toggle button inner contents on mobile', () => {
    cy.mount(<TestSideNav toggleButton="Test Open" />)
  ...
  it('applies `_css` to root and `css` to the container', () => {
    cy.mount(<TestSideNav _css={{ margin: 20 }} css={{ padding: 10 }} />)
